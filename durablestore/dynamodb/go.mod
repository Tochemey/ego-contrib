module github.com/tochemey/ego-contrib/durablestore/dynamodb
...
require (
	...
	github.com/tochemey/ego/v3 v3.3.1
...
require (
	...
	github.com/tochemey/goakt/v2 v2.11.1 // indirect
	github.com/tochemey/olric v0.1.1 // indirect
